...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Occbox" ErrorMessage="*" Font-Bold="True" Font-Size="Larger" Font-Underline="True" ForeColor="Red" ToolTip="Enter Occupation"></asp:RequiredFieldValidator>
            &nbsp;&nbsp;&nbsp;
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Namebox" ErrorMessage="Not Valid Input" Font-Bold="True" ForeColor="Red" ValidationExpression="^[a-zA-Z'.\s]{5,40}$" ></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style6">
   ...
   <asp:Button ID="Submitbtn" runat="server" Font-Bold="True" ForeColor="Black" Text="Submit" OnClick="Submitbtn_Click" Height="25px" Font-Size="Medium" />
